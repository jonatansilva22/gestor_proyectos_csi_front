...
export const ProjectActions = ({ projectId, onDelete }: ProjectActionsProps) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 items-center justify-center w-full sm:w-auto">
      ...
      <button
        className={`w-full sm:w-auto min-w-[120px] px-4 py-3 sm:px-6 sm:py-2 rounded-lg font-medium text-sm sm:text-base transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 active:scale-95 cursor-pointer ${
          darkMode 
