...
export const ProjectDataTable = ({
  ...
  return (
    <div>
      <div
        className={`font-semibold text-center mb-2 pb-3 ${
      ...
      >
        <DataRow
          ...
          editable={canEdit}
          inputType="select"
          options={[{ value: "", label: "— Sin grupo —" }, ...groupsOptions]} // 👈 aquí
        ...
        <DataRow
          ...
          renderDisplay={() => {
            ...
            return (
              <span
                className={`inline-block px-3 py-1 text-sm font-semibold rounded-full ${textColor} ${containerClasses}`}
              >
                {statusName}
              </span>
            );
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {(user.role || user.role_id) && (
                          ...
                          >
                            ...
                            {ROLE_NAMES[
                              (user.role ||
                                user.role_id) as keyof typeof ROLE_NAMES
                            ] || "Usuario"}
                          </span>
                        )}
                      </div>
