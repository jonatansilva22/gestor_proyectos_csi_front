...
export const NewItemButton = ({ label, onClick, icon }: NewItemButtonProps) => {
  ...
  return (
    <button
      className={`px-4 py-3 sm:px-6 sm:py-2 text-base sm:text-sm font-medium rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 active:scale-95 min-h-[44px] w-full sm:w-auto flex items-center justify-center gap-2 ${
        darkMode
